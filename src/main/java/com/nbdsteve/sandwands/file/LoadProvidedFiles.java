package com.nbdsteve.sandwands.file;

import com.nbdsteve.sandwands.SandWands;
import com.nbdsteve.sandwands.file.providedfile.GenerateProvidedFile;
...
public class LoadProvidedFiles {
    ...
    public LoadProvidedFiles() {
        ...
        fileList.put(Files.LIGHTNING, new GenerateProvidedFile("sand.yml"));
    ...
    public FileConfiguration getSand() {
